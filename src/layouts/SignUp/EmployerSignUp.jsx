...
export default function EmployerSignUp() {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            webAdress: Yup.string().required("Website boş bırakılamaz!"),
        ...
        onSubmit: (values) => {
            ...
            employerService.register(employer).then((result) => console.log(result.data.message));
                ...
                <Segment>
                    <form onSubmit={formik.handleSubmit} style={{ fontFamily: "Arial", fontWeight: "bold" }}>
                        <div style={{ textAlign: "left" }} >
                            ...
                            <div style={{ marginTop: "1em", marginBottom: "1em" }}>
                                <label>Website:</label>
                                <Input id="website" fluid style={{ marginRight: "1em", marginTop: "1em" }} placeholder='Website...' values={formik.values.webAdress} onChange={formik.handleChange} required></Input>
